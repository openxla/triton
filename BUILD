...
cc_library(
    ...
    srcs = glob(
        ...
        # The functions in this file are used by many files in TritonGPU/Transforms/...
        # Include the file here to avoid circular dependency.
...
cc_library(
    ...
    srcs = glob(
        ...
        # The file included into TritonGPUTransforms target which this target depends on.
        exclude = ["lib/Dialect/TritonNvidiaGPU/Transforms/TMAUtilities.cpp"],
    ),
    hdrs = glob(
        [
        ...
        # The file included into TritonGPUTransforms target which this target depends on.
        exclude = ["include/triton/Dialect/TritonNvidiaGPU/Transforms/TMAUtilities.h"],
    ),
    copts = select({
        ":compiler_is_msvc": [],
        "//conditions:default": [
