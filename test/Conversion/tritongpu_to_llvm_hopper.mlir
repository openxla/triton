// RUN: ENABLE_MMA_V3=1 triton-opt %s -split-input-file --decompose-unsupported-nvidia-conversions --allocate-shared-memory --convert-triton-gpu-to-llvm=compute-capability=90 2>&1 | FileCheck %s
