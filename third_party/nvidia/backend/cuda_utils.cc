...
bool extractTmaDesc(PyObject* obj, void* ptr) {
  ...
  PyObject* method_ret = PyObject_CallMethod(obj, "tma_desc_cpu_ptr", nullptr);
...
static PyObject *fillTMADescriptor(PyObject *self, PyObject *args) {
  ...
  CUDA_CHECK_AND_RETURN_NULL(cuTensorMapEncodeTiled(
      (CUtensorMap *)desc_address, (CUtensorMapDataType)elemType,
      rank, (void *)global_address, shapeInt, stridesLL, blockSizeInt,
